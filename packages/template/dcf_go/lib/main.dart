  ...
  DCFComponentNode render() {
    ...
    return DCFSafeArea(
      ...
      children: [
        ...
        showChild.state
            ? LifecycleTestComponent(count: count.state)
            : DCFText(
...
class LifecycleTestComponent extends DCFStatefulComponent {
  ...
  LifecycleTestComponent({required this.count, super.key});
  ...
  DCFComponentNode render() {
    ...
    useEffect(() {
      print(
        '✅ useEffect: Running effect (count: $count, internalCount: ${internalCount.state})',
      );
    ...
    return DCFView(
      ...
      children: [
        DCFText(
          ...
          textProps: DCFTextProps(fontSize: 20, fontWeight: DCFFontWeight.bold),
  ...
  void componentDidUpdate(Map<String, dynamic> prevProps) {
    ...
    print(
      '   Previous count: ${prevProps['count'] ?? 'N/A'}, New count: $count',
    );
  }
