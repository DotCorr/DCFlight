...
import 'package:dcf_go/screen_utilities.dart';
    ...
    return DCFView(
      ...
      children: [
        ...
        DCFView(
          ...
          children: [
            if (showScreenUtilsTest.state)
              ScreenUtilitiesTest(
                onClose: () {
                  showScreenUtilsTest.setState(false);
                },
              )
        ...
        DCFTouchableOpacity(
          ...
          children: [
            DCFText(
              content: showScreenUtilsTest.state 
                  ? '← Close Test'
                  : showExamples.state 
                      ? '← Landing' 
                      : 'Examples →',
        ...
        // Screen Utilities Test Button - positioned absolutely in top-left
        DCFTouchableOpacity(
          layout: DCFLayout(
            position: DCFPositionType.absolute,
            absoluteLayout: AbsoluteLayout(
