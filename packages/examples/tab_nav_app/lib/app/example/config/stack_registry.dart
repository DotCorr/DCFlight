import '../features/navigation_demo/pages/deep_screen.dart';
import '../features/navigation_demo/pages/details.dart';
import '../features/navigation_demo/pages/modal_screen.dart';
import '../features/navigation_demo/pop_overs/info.dart';
    ...
    return DCFFragment(
      children: [
        ...
        DCFScreen(
          ...
          // U may use portals to render one pop over with different content
