...
App buildApp() => App(
  version: 2, id: 'com.dotcorr.nativeoperation', name: 'Native operation',
  sdkCatalog: 'sdk.sqlite', state: {'identifier': '', 'status': 'Ready'},
  nativeOperations: [NativeOperation(name: 'newIdentifier',
    execution: NativeExecution.main, result: NativeScalar.string,
  ...
  routes: [Screen(id: 'home', title: 'Native operation', body: Column(id:'content', children:[
